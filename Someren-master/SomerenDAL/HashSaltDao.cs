...
namespace SomerenDAL
{
    public class HashSaltDao : BaseDao
    {
        ...
        public void UpdatePassword(User user)
        {
            ...
            sqlParameters[0] = new SqlParameter("@hash", user.HashSalt.Hash);
            sqlParameters[1] = new SqlParameter("@salt", user.HashSalt.Salt);
            sqlParameters[2] = new SqlParameter("@username", user.Username);
